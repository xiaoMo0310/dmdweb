    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout" v-if="order.orderType === 2">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">{{order.receiverZipCode | formatNull}}</el-col>
    ...
    <el-dialog title="修改收货人信息"
      ...
      <el-form :model="receiverInfo"
        ...
        <el-form-item label="手机号码：">
          <el-input v-model="receiverInfo.receiverMobileNo" style="width: 200px">
          </el-input>
        </el-form-item>
        <el-form-item label="邮政编码：">
          <el-input v-model="receiverInfo.receiverZipCode" style="width: 200px">
          </el-input>
        </el-form-item>
        <el-form-item label="所在区域：">
          <v-distpicker :province="receiverInfo.provinceName"
                        :city="receiverInfo.cityName"
                        :area="receiverInfo.districtName"
