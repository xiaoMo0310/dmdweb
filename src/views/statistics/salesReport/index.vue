...
<script>
  import {queryAnalysisReport ,exportOrderStatistics } from '@/api/analysis';
  //import {queryAnalysisReport ,exportOrderStatistics,uploadOrderStatistics } from '@/api/orderStatistics';
      ...
      getList2(){
        exportOrderStatistics (this.listQuery).then(response => {
          if (response.code === 200){
            window.location.href = 'http://localhost:8090' + "/analysis/exportOrderStatistics2?fileName=" + encodeURI(response.data) + "&delete=" + true;
          }
